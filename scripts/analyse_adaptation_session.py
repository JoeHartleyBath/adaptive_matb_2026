...
Usage
-----
    python scripts/analyse_adaptation_session.py \\
...
def load_session_blocks(csv_path: Path) -> list[BlockSegment]:
    ...
    """
    starts: dict[str, tuple[float, str, int]] = {}   # base -> (time, level, block_num)
    ends: dict[str, float] = {}                        # base -> time
    ...
    with open(csv_path, "r", encoding="utf-8", newline="") as f:
        ...
        for row in reader:
            ...
            # Strip STUDY/V0/ prefix for matching
            body = raw_value
