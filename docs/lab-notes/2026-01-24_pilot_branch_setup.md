...
2.  **Scenario Setup:**
    ...
    *   **Training/Retained:** Generated using `generate_pilot_scenarios.py` with validated difficulty levels (Low: 0.2, Mod: 0.55, High: 0.95).
...
*   **Scenario Verification:** Manually test run the generated Training and Retained scenarios to confirm difficulty levels and timing.
*   **Full Pipeline Test:** Execute full pilot runs (Training sequence + Retained blocks) in interactive mode.
*   **NASA-TLX Verification:** Confirm the NASA-TLX questionnaire triggers correctly after Retained blocks and saves data properly.
